...
public final class userlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$(\"#editUserWindow\").window(\"open\");\r\n");
      out.write("\t\t\tvar rows = $('#grid').datagrid('getSelections');\r\n");
      out.write("\t\t\tconsole.log(rows[0])\r\n");
      out.write("\t\t\t$(\"#editUserForm\").form(\"load\",rows[0]);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}, {\r\n");
      ...
      out.write("\t}  ] ];\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\t$(\"#editUserWindow\").window(\"close\");\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t$('#editUserWindow').window({\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"用户添加修改\" id=\"editUserWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar flag=$(\"#editUserForm\").form(\"validate\");\r\n");
      out.write("\t\t\t\t\t\t\tif (flag){\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#editUserForm\").submit();\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t</script>\r\n");
      ...
      out.write("\t\t\t<form id=\"editUserForm\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/userAction_edit\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>生日:</td><td><input type=\"text\" name=\"birthdayString\" id=\"birthday\" class=\"easyui-datebox\" /></td></tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" data-options=\"validType:'telephone'\" name=\"telephone\" id=\"telephone\" class=\"easyui-validatebox\" required=\"true\" />\r\n");
      out.write("\t\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\t\t$(function () {\r\n");
      ...
      out.write("\t\t\t\t\t\t<td id=\"selectRole\">\r\n");
      out.write("\t\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\t\t$.post(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/userAction_ajaxList\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfunction (data) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfor (var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t$(\"#selectRole\").append(\"<input type='radio' id='\"+data[i].id+\"' class='checkboxInput' name='roleIds' value='\"+data[i].id+\"'/><label for='\"+data[i].id+\"'>\"+data[i].name+\"</label>\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t)\r\n");
      out.write("\t\t\t\t\t\t\t</script>\r\n");
