 ...
 * Generated at: 2019-06-19 02:34:11 UTC
...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$('#editDecidedzoneWindow').window(\"open\");\r\n");
      out.write("\t\t\t$(\"#staff .combo-text\").val(rows[0].staff.name);\r\n");
      out.write("\t\t\t$(\"#staff .combo-value\").val(rows[0].staff.id);\r\n");
      out.write("\t\t\t$(\"#editSubareaGrid\").datagrid({\r\n");
      out.write("\t\t\t\tfitColumns:true,\r\n");
      out.write("\t\t\t\tsingleSelect:false,\r\n");
      out.write("\t\t\t\tborder:false,\r\n");
      out.write("\t\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_associationSubarea?id='+rows[0].id,\r\n");
      out.write("\t\t\t\tcolumns:[[{\r\n");
      out.write("\t\t\t\t\tfield : 'subareaid',\r\n");
      out.write("\t\t\t\t\twidth:30,\r\n");
      ...
      out.write("\t\t\t\t\t\t$(\"#editSubareaGrid\").datagrid('selectRow',i);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#editDecidedzoneForm\").form(\"load\",rows[0]);\r\n");
      out.write("\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\t$.messager.alert(\"选择定区\",\"请选择一个定区\",\"warning\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t$.messager.alert(\"选择删除的定区\",\"请选择需要删除的定区！\",\"warning\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\twindow.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_delete?ids=\"+arr.join(',');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\t$.messager.alert(\"选择定区\",\"请选择一个定区！\",\"warning\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tvar id=arr[0];\r\n");
      out.write("\t\t\t$('#customerWindow').window('open');\r\n");
      out.write("\t\t\t$(\"#customerDecidedZoneId\").val(id);\r\n");
      ...
      out.write("\t\t\t\t\t\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_noassociation\",\r\n");
      out.write("\t\t\t\t\tfunction (data) {\r\n");
      out.write("\t\t\t\t\t\tif (data.length!==0){\r\n");
      out.write("\t\t\t\t\t\t\tfor (var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t$('#noassociationSelect').append(\"<option  value='\"+data[i].id+\"'>\"+data[i].name+\"(\"+data[i].telephone+\")\"+\"</option>\");\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\"json\"\r\n");
      ...
      out.write("\t\t\t\t\t\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_association\",\r\n");
      out.write("\t\t\t\t\t{\"id\":id},\r\n");
      out.write("\t\t\t\t\tfunction (data) {\r\n");
      out.write("\t\t\t\t\t\tif (data.length!==0){\r\n");
      out.write("\t\t\t\t\t\t\tfor (var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t$('#associationSelect').append(\"<option  value='\"+data[i].id+\"'>\"+data[i].name+\"(\"+data[i].telephone+\")\"+\"</option>\");\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\tvar rightSelect=document.getElementById(\"associationSelect\");\r\n");
      out.write("\t\t\t\t\t\t\tvar leftSelect=document.getElementById(\"noassociationSelect\");\r\n");
      out.write("\t\t\t\t\t\t\tvar leftItems=leftSelect.children;\r\n");
      out.write("\t\t\t\t\t\t\tvar rightItems=rightSelect.children;\r\n");
      out.write("\t\t\t\t\t\t\tleftSelect.ondblclick = function () {\r\n");
      out.write("\t\t\t\t\t\t\t\trightSelect.appendChild(leftItems[leftSelect.selectedIndex]);\r\n");
      out.write("\t\t\t\t\t\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\trightSelect.ondblclick = function () {\r\n");
      out.write("\t\t\t\t\t\t\t\tleftSelect.appendChild(rightItems[rightSelect.selectedIndex]);\r\n");
      out.write("\t\t\t\t\t\t\t};\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\"json\"\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t} ,{\r\n");
      out.write("\t\tfield : 'delflag',\r\n");
      out.write("\t\ttitle : '是否被删除',\r\n");
      out.write("\t\twidth : 200,\r\n");
      out.write("\t\talign : 'center',\r\n");
      out.write("\t\tformatter : function(data,row, index){\r\n");
      out.write("\t\t\tif(data=='0'){\r\n");
      out.write("\t\t\t\treturn \"未删除\"\r\n");
      out.write("\t\t\t}else{\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_list\",\r\n");
      ...
      out.write("\t    });\r\n");
      out.write("\t\t$('#editDecidedzoneWindow').window({\r\n");
      out.write("\t\t\ttitle: '修改定区',\r\n");
      out.write("\t\t\twidth: 600,\r\n");
      out.write("\t\t\tmodal: true,\r\n");
      out.write("\t\t\tshadow: true,\r\n");
      out.write("\t\t\tclosed: true,\r\n");
      ...
      out.write("\t\t\tvar flag=$(\"#editDecidedzoneForm\").form(\"validate\");\r\n");
      out.write("\t\t\tif (flag){\r\n");
      out.write("\t\t\t\t$(\"#editDecidedzoneWindow\").window(\"close\");\r\n");
      out.write("\t\t\t\t$(\"#editDecidedzoneForm\").submit();\r\n");
      out.write("\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t})\r\n");
      out.write("\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\r\n");
      out.write("\tfunction doDblClickRow(index,row){\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_associationSubarea?id=\"+row.id,\r\n");
      out.write("\t\t\tcolumns : [ [{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_association?id=\"+row.id,\r\n");
      out.write("\t\t\tcolumns : [[{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<!-- 添加 修改分区 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"定区添加\" id=\"addDecidedzoneWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_add\" method=\"post\">\r\n");
      ...
      out.write("    \t\t\t\t\t\t\tdata-options=\"valueField:'id',textField:'name',mode:'remote',url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/staffAction_staffList'\" />\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/subareaAction_subareaList',\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"定区添加\" id=\"editDecidedzoneWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      out.write("\t\t<div style=\"height:31px;overflow:hidden;\" split=\"false\" border=\"false\" >\r\n");
      out.write("\t\t\t<div class=\"datagrid-toolbar\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t<div style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form id=\"editDecidedzoneForm\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZoneAction_edit\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"2\">定区信息</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr height=\"300\" class=\"associationSub\">\r\n");
      out.write("\t\t\t\t\t\t<td valign=\"top\">关联分区</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table id=\"editSubareaGrid\"  style=\"width:300px;height:300px\" class=\"editSubareaGrid\">\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t$('#customerWindow').window('close');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\r\n");
