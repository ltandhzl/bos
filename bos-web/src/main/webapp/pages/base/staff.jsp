...
<script type="text/javascript">
	...
	function doDelete(){
		...
		if (arr.length===0){
			...
			$.messager.confirm("删除取派员","确定要删除吗？",function (flag) {
				if (flag){
					location.href = "${pageContext.request.contextPath}/staffAction_delete?ids="+arr.join(',');
				}
			});
		}
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="对收派员进行添加或者修改" id="addStaffWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="staffForm" action="${pageContext.request.contextPath}/staffAction_add" method="post">
